...
router = fastapi.APIRouter(prefix="/hazid", tags=["hazid"], dependencies=[fastapi.Depends(require_menu_access("hazid"))])
...
@router.post(
    ...
    dependencies=[fastapi.Depends(require_menu_access("hazid", require_upload=True))],
)
