...
router = fastapi.APIRouter(prefix="/hazop", tags=["hazop"], dependencies=[fastapi.Depends(require_menu_access("hazop"))])
...
@router.post(
    ...
    dependencies=[fastapi.Depends(require_menu_access("hazop", require_upload=True))],
)
