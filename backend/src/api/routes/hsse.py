...
router = fastapi.APIRouter(prefix="/hsse", tags=["hsse"], dependencies=[fastapi.Depends(require_menu_access("hsse"))])
...
@router.post(
    ...
    dependencies=[fastapi.Depends(require_menu_access("hsse", require_upload=True))],
)
