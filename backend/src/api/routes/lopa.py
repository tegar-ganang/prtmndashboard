...
router = fastapi.APIRouter(prefix="/lopa", tags=["lopa"], dependencies=[fastapi.Depends(require_menu_access("lopa"))])
...
@router.post(
    ...
    dependencies=[fastapi.Depends(require_menu_access("lopa", require_upload=True))],
)
